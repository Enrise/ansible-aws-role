...
# Source from: https://raw.githubusercontent.com/colinbjohnson/aws-missing-tools/master/ec2-automate-backup/ec2-automate-backup.sh
...
while getopts :s:c:r:v:t:k:u:pnh opt; do
  case $opt in
